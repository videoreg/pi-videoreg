...
PYTHON_CMD="\"$VIDEOREG_PROJECT_HOME/.venv/bin/python3\" \"$VIDEOREG_PROJECT_HOME/run.py\" --service=\"vrg-modem\" --videoreg-project-home=\"$VIDEOREG_PROJECT_HOME\" --log-level=\"$LOG_LEVEL\""
if [[ -n "$ENV" ]]; then
