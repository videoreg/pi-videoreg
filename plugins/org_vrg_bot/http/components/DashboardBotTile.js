// Dashboard tile: Telegram bot status.
// Data: bot.get_status → { configured, healthy, last_error, last_ok_at }.
const DashboardBotTile = {
  ...
  template: `
    ...
    <div v-else-if="data" class="dashboard-tile" @click="$emit('navigate', 'telegram')">
      <div class="dashboard-tile-header">
        <span class="dashboard-tile-icon"><icon name="tg" :size="20"></icon></span>
        <span class="dashboard-tile-title">{{ $t('bot.telegram.menu') }}</span>
