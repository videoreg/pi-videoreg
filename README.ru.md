...
Если вы используете USB-модем, то вы можете настроить выпонение команд и переадресацию SMS ваш мобильный телефон. Для этого укажите свой номер телефона в Настройках `SMS`.
