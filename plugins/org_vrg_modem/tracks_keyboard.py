      ...
      [
        {
          ...
          "callback_data": f"command__modem__send_track__{file_name}",
        },
      ]
    )
      ...
      buttons_row.append(
        {
          ...
          "callback_data": f"command__modem__list_tracks__{x5_page}",
        }
      )

    buttons_row.append(
      {"text": "⬅️ Earlier", "callback_data": f"command__modem__list_tracks__{next_page}"}
    )
  if page > 1:
    prev_page = page - 1
    buttons_row.append(
      {"text": "Later ➡️", "callback_data": f"command__modem__list_tracks__{prev_page}"}
    )
