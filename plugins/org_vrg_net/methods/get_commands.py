...
"""
    ...
    return {
      ...
      "bot_buttons": [
        [
          {"text": "Get connections", "callback_data": "button_plugin__net.connections_commands"}
        ],
        [
          {"text": "WiFi: unblock", "callback_data": "button_plugin__net.wifi_unblock"},
          {"text": "WiFi: block", "callback_data": "button_plugin__net.wifi_block"},
        ],
      ],
    }
